...
export default defineConfig(({ command, mode }) => {
    ...
    return {
        base: isProduction ? './' : '/', // Use './' for production, '/' for development
        publicDir: 'public', // Serve static assets from the 'public' folder
        build: {
            ...
            rollupOptions: {
                input: {
                    ...
                    viz1: resolve(__dirname, 'visualizations/viz1/index.html'),
