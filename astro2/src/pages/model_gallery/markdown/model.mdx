---
import duckImage from '/img/foto/automatic_duck.jpg'
---



# Model
A model is a simplified version of some part or feature of the real world. Models are regularly devised to test a theory. Especially in fields where laboratory experimentation is impossible or unfeasible (astronomy, social science) the replication of a real system facilitates the study of its mechanisms. 
...
The concomitant reductionism of modeling is sometimes ludicrous, let’s us get to the gist of the matter. Here are some proven advantages listed:
...
The homo oeconomicus was highly influential, it left a mark on the design of many institutions and thereby on the perception of ourselves as rational beings. To be sure, the model was controversial from the get-go, and it was the beginning of the mathematization of economics and its divorce from political, social and historical science. The economic man has served the field well. Even if psychology presented a host of human tendencies to act irrational (cognitive biases).
...
Artificial intelligence is a good example of transferring a biological concept into technology. Neural nets were inspired by our own the neural architecture of our brains, and in turn AI’s practical findings gave neuroscientists new ideas about the workings of the mind, which remains enigmatic (Ford, 2018). AI also rekindled an old debate about the nature of intelligence. Some researchers deem it misleading to call machines intelligent. Machines are able to do marvelous things employing advanced statistics and computing power on mountains of data, but lack imagination, empathy and are confined to the quantifiable (Lawrence, 2024). Data guzzling, probability crunching machines are replacing humans in many tasks otherwise attributed to rational decision-making, the optimistic takeaway is that we can now concentrate on our distinctly humane qualities and shift away from the homo oeconomicus paradigm. The fear, on the other hand, is that machines do the grown up stuff while humans become dependent cretins (Gerlich, 2025).

We may prevent this by thinking in a structured way. As a thinking aid, a lens for observations or a device to organize information into knowledge, models support us in making sense of the world. They are meant to be compared, dismissed or reassembled differently. And we should certainly not fall in love with one but have “a crowd of models” (Page, 2018) at our disposal, to tackle problems from various angles.
...
Bee, M., & Desmarais-Tremblay, M. (2023). The Birth Of Homo Œconomicus: The Methodological Debate On The  Economic Agent From J. S. Mill To V. Pareto. _Journal of the History of Economic Thought_, _45_(1), 1–26. [https://doi.org/10.1017/S1053837221000535](https://doi.org/10.1017/S1053837221000535)
