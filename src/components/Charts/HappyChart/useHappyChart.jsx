...
function getThemeColors() {
  ...
  return {
    ...
    heading: isDark
      ? getComputedStyle(document.documentElement).getPropertyValue('--color-accent-dark').trim() || '#E2CAD5'
      : getComputedStyle(document.documentElement).getPropertyValue('--color-accent').trim() || '#422432',
    link: isDark
      ? getComputedStyle(document.documentElement).getPropertyValue('--color-accent-dark').trim() || '#E2CAD5'
      : getComputedStyle(document.documentElement).getPropertyValue('--color-accent').trim() || '#422432',
    bg: isDark
...
export const useHappyChart = (containerRef, data) => {
  useEffect(() => {
    ...
    const styleAxis = (selection) => {
      selection.selectAll('text').attr('fill', colors.text).style('font-family', "'Work', sans-serif");
      selection.selectAll('line').attr('stroke', colors.text);
      selection.select('.domain').attr('stroke', colors.text);
    };
    ...
    g.append('text')
      ...
      .attr('fill', colors.heading)
      .attr('font-family', "'Work', sans-serif")
